...
readonly SCRIPT_REPOSITORY="chiyamahisayoshi/X-backup"
readonly XRAYR_REPOSITORY="XrayR-project/XrayR"
readonly RAW_BASE="https://raw.githubusercontent.com/${SCRIPT_REPOSITORY}/master"
...
url="https://github.com/${XRAYR_REPOSITORY}/releases/download/v${version}/XrayR-linux-${asset_arch}.zip"
