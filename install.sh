...
install_XrayR() {
    ...
    file="https://raw.githubusercontent.com/chiyamahisayoshi/X-backup/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/chiyamahisayoshi/X-backup/master/XrayR.sh
